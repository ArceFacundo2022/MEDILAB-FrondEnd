        ...
        return (
            <header id="header" className="fixed-top">
                ...
                <nav id="navbar" className="navbar order-last order-lg-0">
                    ...
                    <li><a className="nav-link scrollto" href="#services">Buscar Usuario</a></li>
                    </ul>
                    <i className="bi bi-list mobile-nav-toggle"></i>
                </nav>

                <Link to="/Filtro" className="appointment-btn scrollto"><span className="d-none d-md-inline">Consultar tus historias</span> AHORA!</Link>
